(function($) {
    ...
    $(function(){
        ...
        if ($('.header-main_1').hasClass('homepage-01')) {
            if ($(window).width() > 767) {
                var topmenu = $(".header-topbar").height();

                $(window).scroll(function () {
                    if ($(window).scrollTop() > topmenu) {
                        $(".header-main_1.homepage-01").addClass('header-fixed');
                    }
                    else {
                        $(".header-main_1.homepage-01").removeClass('header-fixed');
                    };
                });
            }
            else {
        ...
        else if ($('.header-main_1').hasClass('homepage-02')) {
            var $topmenu = $(".choose-course-2"),
                offset = $topmenu.offset();

            $(window).scroll(function () {
                if ($(window).scrollTop() > offset.top - 1) {
                    $(".header-main_1.homepage-02").addClass('header-fixed');
                }
                else {
                    $(".header-main_1.homepage-02").removeClass('header-fixed');
                }
            });
        ...
        else if ($('.header-main_1').hasClass('homepage-03')) {
            var $topmenu = $(".section.slider-banner-03"),
                offset = $topmenu.offset();

            $(window).scroll(function () {
                if ($(window).scrollTop() > offset.top) {
                    $(".header-main_1.homepage-03").addClass('header-fixed');
                }
                else {
                    $(".header-main_1.homepage-03").removeClass('header-fixed');
                }
            });
        }
        // -------------------------------------//
        ...
        if ($(window).width() <= 1024) {
            ...
            $(window).scroll(function (event) {
                ...
                if (st > lastScroll) {
                    ...
                    $('.header-main_1').addClass('hide-menu');
                }
                else {
                    //Replace this with your function call for upward-scrolling
                    $('.header-main_1').removeClass('hide-menu');
                }

                if ($(window).scrollTop() == 0 ){
                    $('.header-main_1').removeClass('.header-fixed').removeClass('hide-menu');
                };
        ...
        $(window).scroll(function (event) {
            ...
            if ($(window).scrollTop() < 52) {
                var screen_height = $(window).height() - $('.header-main_1').height() - $('.header-topbar').height(),
                ...
                var screen_height = $(window).height() - $('.header-main_1').height(),
                    navigation = $('.navigation').height();
